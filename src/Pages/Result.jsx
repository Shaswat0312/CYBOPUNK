  ...
  const getMessage = () => {
   ...
   return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#020409] via-[#0a1a2f] to-[#00040d] text-white relative overflow-hidden">
      ...
      <div className="z-10 p-10 max-w-xl w-full bg-white/10 backdrop-blur-2xl border border-cyan-400/30 rounded-2xl shadow-[0_0_30px_#00ffff44,0_0_60px_#00ffff22] ring-1 ring-cyan-300/30 transition-all duration-500  space-y-6 text-center animate-fade-in-fast hover:shadow-[0_0_50px_#00ffffaa,0_0_90px_#00ffff55]">

        <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-pink-400 to-purple-500">🎉 Mission Complete</h1>
        ...
        <button onClick={handleRestart}  className="mt-6 inline-block px-8 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-purple-600 hover:to-cyan-500 text-white font-bold rounded-lg shadow-lg hover:shadow-cyan-500/50 transition-all duration-300">
          🔄 Restart Challenge
        </button>
      </div>
    </div>
